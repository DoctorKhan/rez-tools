function [SteadyStateMagnitudeOfTransverseComponent, vMagnitudeOfTransverseComponent, SteadyStatePhase] = SSFPDiscrete(fTR, fAlpha, fT1, fT2, fBeta, iIterations)
...
%% Output
mData = mPlusData;
vMagnitudeOfTransverseComponent = vTransverse(mData);
SteadyStateMagnitudeOfTransverseComponent = vMagnitudeOfTransverseComponent(end);
SteadyStatePhase = atan(mData(2,end) / mData(1,end))*(180/pi);
